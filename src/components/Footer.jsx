        ...
        <div className="bg-bg">
            ...
            >
                <div className="bg-primary p-10 rounded-lg">
                    ...
                    <p className="text-white text-base mt-5">Empresa lider en venta de motocicletas y motos de alta gama, con una amplia variedad de modelos y diseños.</p>
                </div>
                <div className="p-10">
                    <h1 className="text-white font-bold text-2xl">Enlaces</h1>
                    <ul className="text-white text-base mt-5 space-y-5 b">
                        <li>
                            <a href="/" className="border-b-2 border-white">Inicio</a>
                        </li>
                        <li>
                            <a href="/products" className="border-b-2 border-white">Tienda</a>
                        </li>
                    </ul>
                </div>
                <div className=" p-10">
                    ...
                    <div className="flex flex-col space-y-3 mt-5 text-white">
                        <div className="flex items-center gap-4">
                            <img src="https://img.icons8.com/?size=48&id=118497&format=png" alt="Facebook" className="w-6 h-6 " />
                            <a href="https://www.facebook.com/bluemotors.es/">Facebook</a>
                        </div>
                        <div className="flex items-center gap-5">
                            <img src="https://img.icons8.com/?size=48&id=Xy10Jcu1L2Su&format=png" alt="Instagram" className="w-6 h-6" />
                            <a href="https://www.instagram.com/bluemotors.es/">Instagram</a>
                        </div>
                        <div className="flex items-center gap-5">
                            <img src="https://img.icons8.com/?size=48&id=13963&format=png" alt="Twitter" className="w-6 h-6" />
